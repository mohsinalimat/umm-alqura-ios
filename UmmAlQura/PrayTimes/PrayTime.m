...
-(id) init {
	...
	if(self){
		...
		[methodParams setObject:Jvalues forKey:[NSNumber numberWithInt: (int)Jafari]];
		...
		[methodParams setObject:Kvalues forKey:[NSNumber numberWithInt: (int)Karachi]];
		...
		[methodParams setObject:Ivalues forKey:[NSNumber numberWithInt: (int)ISNA]];
		...
		[methodParams setObject:Mvalues forKey:[NSNumber numberWithInt: (int)MWL]];
		...
		[methodParams setObject:Mavalues forKey:[NSNumber numberWithInt: (int)Makkah]];
		...
		[methodParams setObject:Evalues forKey:[NSNumber numberWithInt: (int)Egypt]];
		...
		[methodParams setObject:Tvalues forKey:[NSNumber numberWithInt: (int)Tehran]];
		...
		[methodParams setObject:Cvalues forKey:[NSNumber numberWithInt: (int)Custom]];
...
-(void)setCustomParams: (NSMutableArray*)params {
	int i;
	id j;
	id Cust = [methodParams objectForKey: [NSNumber numberWithInt:(int)Custom]];
